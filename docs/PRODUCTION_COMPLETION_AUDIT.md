...
| PostgreSQL-transacties | Uitvoerbaar voorbereid | Schema en migraties 0001–0015, rij- en idempotentielocks, autorisatie, checksum-preflight, transactionele beginimport en verificatie achteraf | Beheerde `DATABASE_URL`, migraties uitvoeren en fysieke begintelling |
