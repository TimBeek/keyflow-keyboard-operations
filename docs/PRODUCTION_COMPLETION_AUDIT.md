...
| PostgreSQL-transacties | Uitvoerbaar voorbereid | Schema en migraties 0001–0016, rij- en idempotentielocks, autorisatie, checksum-preflight, transactionele beginimport en verificatie achteraf | Beheerde `DATABASE_URL`, migraties uitvoeren en fysieke begintelling |
| Back-up, herstel en operationele readiness | Controlelaag gereed | Management registreert RPO/RTO en vijf integriteitscontroles; centrale API, audit, CI-smoketest en alleen-lezen databasecheck bewaken de laatste proef | Providerback-upbeleid activeren, echte restore buiten productie uitvoeren en cloudalarmering aansluiten |
| Persoonlijke werknemer/managementlogin | Technisch voorbereid en centraal gekoppeld | Tenantgebonden Entra/OIDC, app-rollen, achtuurs sessies, gebruikerssynchronisatie, gedeactiveerde-accountblokkade, beveiligde API-actor en centrale recovery/readiness-synchronisatie | Echte Entra-appregistratie, roltoewijzingen, MFA/Conditional Access en acceptatietest |
...
| Werkvloeracceptatie | Uitvoeringsflow gereed, bewijs ontbreekt | Managementdossier voor scanner/apparaat, deelnemers, doorlooptijd, alle vier methoden, foutscenario en zes controles; harde slagingsregels, lokale back-up, persoonlijke centrale API, audit en PostgreSQL-constraints; proef blijft gescheiden van poortgoedkeuring | Echte scanners, tablet/werkstation, hangmappenwagen en medewerkers gebruiken, bewijs vastleggen en apart door de eigenaar laten goedkeuren |

## Conclusie

De aantoonbare voortgang is 96%. De zelfstandig bouwbare broncatalogus, werknemerslogica, managementanalyse, modelkoppelingen, veiligheidsblokkades, sessiegebonden centrale continuïteitssynchronisatie, veilige productiebootstrap, herstel/readiness-controlelaag en het formele `5/5`-acceptatiedossier zijn aanwezig. De resterende 4% bestaat uit beheerde centrale infrastructuur en een echte providerrestore, echte Entra-tenantacceptatie, de werkelijke orderbron, formeel compatibiliteitsbewijs en fysieke werkvloeracceptatie. Deze onderdelen mogen niet met demo-informatie als “gereed” worden gemarkeerd.
