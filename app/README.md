...
Onder `Continuïteit` ziet management zeven productiepoorten en registreert het een echt uitgevoerde herstelproef met RPO/RTO en vijf integriteitscontroles. Migratie `0014_recovery_drills.sql`, `GET/POST /api/operations/recovery-drills` en `db:operations:check` ondersteunen centrale audit en bewaking. De registratie voert zelf nooit een providerrestore uit. Zie `../docs/RECOVERY_AND_OPERATIONAL_READINESS.md`.
